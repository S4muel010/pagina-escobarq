document.addEventListener("DOMContentLoaded", function () {
    ...
    function ocultarTodosLosContenidos() {
        ...
        const todasLasDescripciones = document.querySelectorAll('.service-description p');
    ...
    configurarMenu("menuAlcantarillados", "imgAlcantarillados", "descAlcantarillados");
    ...
    configurarMenu("menuRemodelaciones", "imgRemodelaciones", "descRemodelaciones");
    configurarMenu("menuReconstruccion", "imgReconstruccion", "descReconstruccion");
    configurarMenu("menuRestauracion", "imgRestauracion", "descRestauracion");
    configurarMenu("menuParques", "imgParques", "descParques");
    configurarMenu("menuEspaciosDeportivos", "imgEspaciosDeportivos", "descEspaciosDeportivos");
